...
#ifdef MHYPER
	int mem_vmid;
	mem_vmid = _mhdebug("MEM: vmid=", mem_vmid);
	mem_vmid = _mhdebug("MEM: vmid=", mem_vmid);
#endif /*  MHYPER */ 
...
#ifdef MHYPER
	_mhdebug("MEM: BOOT_DEV dv_base",m_geom[BOOT_DEV].dv_base);
	_mhdebug("MEM: BOOT_DEV dv_size",m_geom[BOOT_DEV].dv_size);
#endif /*  MHYPER */
...
#ifdef MHYPER
	_mhdebug("MEM: IMGRD_DEV dv_base",m_geom[IMGRD_DEV].dv_base);
	_mhdebug("MEM: IMGRD_DEV dv_size",m_geom[IMGRD_DEV].dv_size);
#endif /*  MHYPER */
