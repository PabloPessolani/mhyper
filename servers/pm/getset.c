...
/* Handle GETSEP */
  ...
  m.DS_KEY = 0x1234;
  if (OK != (rcode = _taskcall(DS_PROC_NR, DS_RETRIEVE, &m))) {
        printf("PM: DS error code=%d errno=%d\n",rcode, errno);
		return(rcode);
	}

 return (m.DS_ENDPOINT); /* testing with VM=0 */
