...
#define SB1_FORMAT 	"s_ninodes=%d s_nzones=%d s_imap_blocks=%d s_zmap_blocks=%d s_firstdatazone=%d\n"
#define SB1_FIELDS(p) p->s_ninodes,p->s_nzones,p->s_imap_blocks,p->s_zmap_blocks,p->s_firstdatazone

#define SB2_FORMAT 	"s_magic=%X s_zones=%ld s_block_size=%d s_disk_version=%d s_log_zone_size=%d\n"
#define SB2_FIELDS(p) p->s_magic, p->s_zones,p->s_block_size,p->s_disk_version, p->s_log_zone_size
