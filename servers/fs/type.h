...
#define I1_FORMAT 	"d1_mode=%X d1_nlinks=%d d1_uid=%d d1_gid=%d d1_size=%ld\n"
#define I1_FIELDS(p) p->d1_mode,p->d1_nlinks,p->d1_uid,p->d1_gid,p->d1_size
...
#define I2_FORMAT 	"d2_mode=%X d2_nlinks=%d d2_uid=%d d2_gid=%d d2_size=%ld\n"
#define I2_FIELDS(p) p->d2_mode,p->d2_nlinks,p->d2_uid,p->d2_gid,p->d2_size
