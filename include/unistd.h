...
#define SI_VMM_TAB	   8	/* copy of kernel process table */
...
_PROTOTYPE( int execve, (const char *_path, char *const _argv[], 
						char *const _envp[])	);
_PROTOTYPE( int execvm, (int vmsize, const char *_path, char *const _argv[], 
						char *const _envp[])	);
...
#ifdef MHYPER
_PROTOTYPE( vmid_t getvmid, (void)					);
_PROTOTYPE( int getsep, 	(int key)				);
_PROTOTYPE( int vmmcmd,	   	(int cmd, int i2, int i3, void *p1, void *p2, void *p3) );
_PROTOTYPE( int getsysinfo_vm, (int who, int what, void *where, int vmid) );
