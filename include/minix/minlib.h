...
/* Miscellaneous MHYPER */
_PROTOTYPE( int ds_publish, (int key, int flags, long val1, long val2, char *ptr) );
_PROTOTYPE( int ds_retrieve, (int key, int *flags, long *val1, long *val2, char *ptr) );
_PROTOTYPE( int ds_delete, (int key) );
