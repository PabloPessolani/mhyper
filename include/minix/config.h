...
#define OS_RELEASE "3"
#ifdef MHYPER
#define OS_VERSION "1.2MH"
#define MHYPER_DATE "2015.11.24"
#else /*  MHYPER */
...
#ifdef MHYPER
#define NR_VMS			4	/*  MHYPER:  1<= NR_VMS <=32*/
#define MHDBG			1 
#define ENABLE_HDEBUG	1
#if ENABLE_HDEBUG
#define _hdebug 	_hdebug
#else 
#define _hdebug 	_nodebug
#endif
#endif /*  MHYPER */
 ...
 * system can handle.
 */
#define NR_CONS        4 	/* # system consoles BY VM : (1 to 4)  */
#define	NR_RS_LINES	   1    /* # rs232 terminals by VM */
#define	NR_PTYS		   4	/* # pseudo terminals BY VM: (0 to 16) */
#define	NR_RS_MAX 	   2    /* Maximum # rs232 terminals in the SYSTEM */
