...
#ifdef MHYPER
#define EBADVMID	   (_SIGN 401)  /* Bad VMID */
#define EVMSTATUS	   (_SIGN 402)  /* Bad VM status  */
#define EVIRTUALTASK   (_SIGN 403)  /* Bad Virtual TASK */
#define EPROXYSVR	   (_SIGN 404)  /* Bad Proxy SERVER */
#define EPROCSTATUS	   (_SIGN 405)  /* Bad Process status  */
#define EPROCVMID	   (_SIGN 406)  /* Bad VMID */
#define EPROMISCUOUS   (_SIGN 407)  /* Bad Promiscous TASK */
