...
#define NO_STACK	0
#ifdef MHYPER
#define IDL_S	CLICK_SIZE	/* 3 intr, 3 temps, 4 db for Intel */
#define	HRD_S	NO_STACK	/* dummy task, uses kernel stack */
#define	TSK_S	CLICK_SIZE	/* system and clock task */
#else /* MHYPER*/
...
#define SRV_M	(~0)
#define SYS_M	(~0)
#define USR_M (s(PM_PROC_NR) | s(FS_PROC_NR) | s(RS_PROC_NR) | s(VMM_PROC_NR) | s(SYSTEM))
...
/* process nr,   		pc, 	flags, 	qs,  	queue, 	stack, 	traps, 	ipcto, 	call,  name */ 
 { IDLE,  idle_task, IDL_F,  TICKS_TO_SWITCH , IDLE_Q, IDL_S,     0,     0,     0, "idle"  },
 { CLOCK,clock_task, TSK_F,  TICKS_TO_SWITCH , TASK_Q, TSK_S, TSK_T,     0,     0, "clock" },
 { SYSTEM, sys_task, TSK_F,  TICKS_TO_SWITCH , TASK_Q, TSK_S, TSK_T,     0,     0, "system"},
 { HARDWARE,      0, TSK_F,  TICKS_TO_SWITCH , TASK_Q, HRD_S,     0,     0,     0, "kernel"},
 { PM_PROC_NR,    0, SRV_F, TICKS_TO_SWITCH*4,      3, 0,     SRV_T, SRV_M,  PM_C, "pm"    },
 { FS_PROC_NR,    0, SRV_F, TICKS_TO_SWITCH*4,      4, 0,     SRV_T, SRV_M,  FS_C, "fs"    },
 { RS_PROC_NR,    0, SRV_F,  TICKS_TO_SWITCH/2,      3, 0,     SRV_T, SYS_M,  RS_C, "rs"    },
 { DS_PROC_NR,    0, SRV_F,  TICKS_TO_SWITCH/2,      3, 0,     SRV_T, SYS_M,  DS_C, "ds"    },
 { TTY_PROC_NR,   0, SRV_F,  TICKS_TO_SWITCH/2,      1, 0,     SRV_T, SYS_M, TTY_C, "tty"   },
 { MEM_PROC_NR,   0, SRV_F,  TICKS_TO_SWITCH/2,      2, 0,     SRV_T, SYS_M, MEM_C, "mem"   },
 { LOG_PROC_NR,   0, SRV_F,  TICKS_TO_SWITCH/2,      2, 0,     SRV_T, SYS_M, DRV_C, "log"   },
 { VMM_PROC_NR,   0, SRV_F,  TICKS_TO_SWITCH/2,     3, 0,     SRV_T, SYS_M, VMM_C, "vmm"   },
 { INIT_PROC_NR,  0, USR_F,  TICKS_TO_SWITCH, USER_Q, 0,     USR_T, USR_M,     0, "init"  },
};
