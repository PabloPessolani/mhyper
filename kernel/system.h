...
_PROTOTYPE( int do_getvmid, (message *m_ptr) );
_PROTOTYPE( int do_vmmreq, (message *m_ptr) );
_PROTOTYPE( int do_vcopyvm, (message *m_ptr) );
_PROTOTYPE( int do_umapvm, (message *m_ptr) );
_PROTOTYPE( int do_killvm, (message *m_ptr) );

#if ! USE_GETVMID
#define do_getvmid do_unused
#endif
...
#if ! USE_VCOPYVM
#define do_vcopyvm do_unused
#endif

#if ! USE_UMAPVM
#define do_umapvm do_unused
#endif

#if ! USE_KILLVM
#define do_killvm do_unused
#endif
