...
#ifdef MHYPER
#define HDEBUG		   5	/* 0101 */
#define PRTMSG		   6    /* 0110 */
#define SENDAS 		   7    /* 0111 */
/*  ECHO is 8  */
#define RECVAS		   9    /* 1001 */
#define SENDVM 		   10   /* 1010 */
#define RECVVM		   11   /* 1011 */
#define SENDRECVM	   12   /* 1100 */
#define NOTIFYVM	   13   /* 1101 */
#define NOTIFYAS	   14   /* 1110 */
#define RELAY	   	   15   /* 1110 */
