...
#define hwint_master(irq)	\
	...
	pushf			/* MHYPER: save FLAGS*/;\
	cli				/* MHYPER: Disable interrupts*/;\
	call    _proc_rvm	/* MHYPER: Running_vm is proc_ptr->p_vmid */;\
	popf			/* MHYPER: restore FLAGS */;\
...
_p_s_call:
	...
	pushf			! MHYPER: save FLAGS
	cli				! MHYPER: Disable interrupts
	call    _proc_rvm	! MHYPER: Running_vm = proc_ptr->p_vmid 
	popf			! MHYPER: restore FLAGS 
...
! Restart the current process or the next process if it is set. 
	...
	pushf				! MHYPER: save FLAGS
	cli					! MHYPER: Disable interrupts	
	call _next_rvm		! MHYPER : running_vm = next_ptr->p_vmid
	popf				! MYPER: restore FLAGS 
	mov 	eax, (_next_ptr)
