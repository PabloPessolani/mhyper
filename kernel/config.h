...
#define USE_GETVMID    	   1	/* retrieves sender VMID  */
#define USE_VCOPYVM 	   1	/* Copy data between virtual address of process on different VMs */
#define USE_UMAPVM 		   1	/* Map user space memory of a process on different VM */
#define USE_KILLVM 		   1	/* send a signal to a process on different VM */
...
#ifdef MHYPER
#define K_STACK_BYTES   CLICK_SIZE
#else /*  MHYPER */
